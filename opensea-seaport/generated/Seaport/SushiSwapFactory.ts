...
export class SushiSwapFactory extends ethereum.SmartContract {
  static bind(address: Address): SushiSwapFactory {
    return new SushiSwapFactory("SushiSwapFactory", address);
  }
