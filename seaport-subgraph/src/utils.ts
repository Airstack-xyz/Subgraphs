...
export const EXCHANGE_ADDRESS = Address.fromString("0x00000000006c3852cbef3e08e8df289169ede581")
...
export function isERC721(itemType: i32): boolean {
  return itemType == SeaportItemType.ERC721 || itemType == SeaportItemType.ERC721_WITH_CRITERIA
}

export function isERC1155(itemType: i32): boolean {
  return itemType == SeaportItemType.ERC1155 || itemType == SeaportItemType.ERC1155_WITH_CRITERIA
}
...
export function isOpenSeaFeeAccount(address: Address): boolean {
  const OPENSEA_WALLET_ADDRESS = Address.fromString("0x5b3256965e7c3cf26e11fcaf296dfc8807c01073")
  const OPENSEA_FEES_ACCOUNT = Address.fromString("0x8de9c5a032463c561423387a9648c5c7bcc5bc90")
...
export function isNFTEntity(itemType: number): bool {
  return itemType >= 2
}
export function getNFTStandard(itemType: i32): string {
  return isERC721(itemType)
    ? NftStandard.ERC721
    : isERC1155(itemType)
    ? NftStandard.ERC1155
    : NftStandard.UNKNOWN
