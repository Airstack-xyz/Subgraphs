...
export class SushiSwapRouter__addLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SushiSwapRouter__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class SushiSwapRouter__removeLiquidityETHResult {
  value0: BigInt;
  value1: BigInt;
...
export class SushiSwapRouter__removeLiquidityETHWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class SushiSwapRouter__removeLiquidityWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class SushiSwapRouter extends ethereum.SmartContract {
  static bind(address: Address): SushiSwapRouter {
    return new SushiSwapRouter("SushiSwapRouter", address);
  }
  ...
  addLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): SushiSwapRouter__addLiquidityResult {
    ...
    return new SushiSwapRouter__addLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_addLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<SushiSwapRouter__addLiquidityResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SushiSwapRouter__addLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  removeLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): SushiSwapRouter__removeLiquidityResult {
    let result = super.call(
      "removeLiquidity",
    ...
    return new SushiSwapRouter__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<SushiSwapRouter__removeLiquidityResult> {
    let result = super.tryCall(
      "removeLiquidity",
      "removeLiquidity(address,address,uint256,uint256,uint256,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SushiSwapRouter__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETH(
    ...
    to: Address,
    deadline: BigInt
  ): SushiSwapRouter__removeLiquidityETHResult {
    let result = super.call(
      "removeLiquidityETH",
    ...
    return new SushiSwapRouter__removeLiquidityETHResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityETH(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<SushiSwapRouter__removeLiquidityETHResult> {
    let result = super.tryCall(
      "removeLiquidityETH",
      "removeLiquidityETH(address,uint256,uint256,uint256,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SushiSwapRouter__removeLiquidityETHResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETHWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): SushiSwapRouter__removeLiquidityETHWithPermitResult {
    let result = super.call(
      "removeLiquidityETHWithPermit",
    ...
    return new SushiSwapRouter__removeLiquidityETHWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityETHWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): ethereum.CallResult<SushiSwapRouter__removeLiquidityETHWithPermitResult> {
    let result = super.tryCall(
      "removeLiquidityETHWithPermit",
      "removeLiquidityETHWithPermit(address,uint256,uint256,uint256,address,uint256,bool,uint8,bytes32,bytes32):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SushiSwapRouter__removeLiquidityETHWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): SushiSwapRouter__removeLiquidityWithPermitResult {
    let result = super.call(
      "removeLiquidityWithPermit",
    ...
    return new SushiSwapRouter__removeLiquidityWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): ethereum.CallResult<SushiSwapRouter__removeLiquidityWithPermitResult> {
    let result = super.tryCall(
      "removeLiquidityWithPermit",
      "removeLiquidityWithPermit(address,address,uint256,uint256,uint256,address,uint256,bool,uint8,bytes32,bytes32):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SushiSwapRouter__removeLiquidityWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
