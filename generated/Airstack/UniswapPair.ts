...
export class UniswapPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniswapPair extends ethereum.SmartContract {
  static bind(address: Address): UniswapPair {
    return new UniswapPair("UniswapPair", address);
  }
  ...
  burn(to: Address): UniswapPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new UniswapPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<UniswapPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): UniswapPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new UniswapPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<UniswapPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
