...
export class SushiSwapPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class SushiSwapPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class SushiSwapPair extends ethereum.SmartContract {
  static bind(address: Address): SushiSwapPair {
    return new SushiSwapPair("SushiSwapPair", address);
  }
  ...
  burn(to: Address): SushiSwapPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new SushiSwapPair__burnResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_burn(to: Address): ethereum.CallResult<SushiSwapPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new SushiSwapPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): SushiSwapPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new SushiSwapPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<SushiSwapPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SushiSwapPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
