...
import { createAirAggregatedEntity } from "./airstack";
import { AirProtocolActionType } from "./airstack/constants";
...
function airstackCallback(): string {
  console.log("airstackCallback called");
  return "airstack callback function called";
}
