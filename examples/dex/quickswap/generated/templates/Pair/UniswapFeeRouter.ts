...
export class UniswapFeeRouter__addLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class UniswapFeeRouter__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapFeeRouter__removeLiquidityETHResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapFeeRouter__removeLiquidityETHWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapFeeRouter__removeLiquidityWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapFeeRouter extends ethereum.SmartContract {
  static bind(address: Address): UniswapFeeRouter {
    return new UniswapFeeRouter("UniswapFeeRouter", address);
  }
  ...
  addLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapFeeRouter__addLiquidityResult {
    ...
    return new UniswapFeeRouter__addLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_addLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapFeeRouter__addLiquidityResult> {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapFeeRouter__addLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getAmountIn(
    ...
    let result = super.call(
      "getAmountIn",
      "getAmountIn(uint256,uint256,uint256,uint256):(uint256)",
      [
  ...
  getAmountOut(
    ...
    let result = super.call(
      "getAmountOut",
      "getAmountOut(uint256,uint256,uint256,uint256):(uint256)",
      [
  ...
  getAmountsIn(
    ...
    let result = super.call(
      "getAmountsIn",
      "getAmountsIn(uint256,address[],uint256):(uint256[])",
      [
        ethereum.Value.fromUnsignedBigInt(amountOut),
  ...
  getAmountsOut(
    ...
    let result = super.call(
      "getAmountsOut",
      "getAmountsOut(uint256,address[],uint256):(uint256[])",
      [
        ethereum.Value.fromUnsignedBigInt(amountIn),
        ethereum.Value.fromAddressArray(path),
        ethereum.Value.fromUnsignedBigInt(fee)
  ...
  removeLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapFeeRouter__removeLiquidityResult {
    let result = super.call(
      "removeLiquidity",
    ...
    return new UniswapFeeRouter__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapFeeRouter__removeLiquidityResult> {
    let result = super.tryCall(
      "removeLiquidity",
      "removeLiquidity(address,address,uint256,uint256,uint256,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapFeeRouter__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETH(
    ...
    to: Address,
    deadline: BigInt
  ): UniswapFeeRouter__removeLiquidityETHResult {
    let result = super.call(
      "removeLiquidityETH",
    ...
    return new UniswapFeeRouter__removeLiquidityETHResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityETH(
    ...
    to: Address,
    deadline: BigInt
  ): ethereum.CallResult<UniswapFeeRouter__removeLiquidityETHResult> {
    let result = super.tryCall(
      "removeLiquidityETH",
      "removeLiquidityETH(address,uint256,uint256,uint256,address,uint256):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapFeeRouter__removeLiquidityETHResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETHWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): UniswapFeeRouter__removeLiquidityETHWithPermitResult {
    let result = super.call(
      "removeLiquidityETHWithPermit",
    ...
    return new UniswapFeeRouter__removeLiquidityETHWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityETHWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): ethereum.CallResult<UniswapFeeRouter__removeLiquidityETHWithPermitResult> {
    let result = super.tryCall(
      "removeLiquidityETHWithPermit",
      "removeLiquidityETHWithPermit(address,uint256,uint256,uint256,address,uint256,bool,uint8,bytes32,bytes32):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapFeeRouter__removeLiquidityETHWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): UniswapFeeRouter__removeLiquidityWithPermitResult {
    let result = super.call(
      "removeLiquidityWithPermit",
    ...
    return new UniswapFeeRouter__removeLiquidityWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): ethereum.CallResult<UniswapFeeRouter__removeLiquidityWithPermitResult> {
    let result = super.tryCall(
      "removeLiquidityWithPermit",
      "removeLiquidityWithPermit(address,address,uint256,uint256,uint256,address,uint256,bool,uint8,bytes32,bytes32):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapFeeRouter__removeLiquidityWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
