...
AIR_CHAIN_ID_MAP.set("arbitrum-one", "");
AIR_CHAIN_ID_MAP.set("arweave-mainnet", "ARWEAVE_MAINNET");
AIR_CHAIN_ID_MAP.set("aurora", "AURORA");
AIR_CHAIN_ID_MAP.set("avalanche", "AVALANCHE");
AIR_CHAIN_ID_MAP.set("boba", "BOBA");
AIR_CHAIN_ID_MAP.set("bsc", "BSC");
AIR_CHAIN_ID_MAP.set("celo", "CELO");
AIR_CHAIN_ID_MAP.set("COSMOS", "COSMOS");
AIR_CHAIN_ID_MAP.set("CRONOS", "CRONOS");
AIR_CHAIN_ID_MAP.set("mainnet", "1");
AIR_CHAIN_ID_MAP.set("fantom", "FANTOM");
AIR_CHAIN_ID_MAP.set("fuse", "FUSE");
AIR_CHAIN_ID_MAP.set("harmony", "HARMONY");
AIR_CHAIN_ID_MAP.set("juno", "JUNO");
AIR_CHAIN_ID_MAP.set("moonbeam", "MOONBEAM");
AIR_CHAIN_ID_MAP.set("moonriver", "MOONRIVER");
AIR_CHAIN_ID_MAP.set("near-mainnet", "NEAR_MAINNET");
AIR_CHAIN_ID_MAP.set("optimism", "OPTIMISM");
AIR_CHAIN_ID_MAP.set("osmosis", "OSMOSIS");
AIR_CHAIN_ID_MAP.set("matic", "137");
AIR_CHAIN_ID_MAP.set("xdai", "XDAI");
