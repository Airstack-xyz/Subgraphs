...
import { getHandleTransferEvent, getHandleNewOwnerEvent } from "./ens-registry-utils"
import { handleTransfer, handleNewOwnerOldRegistry, handleNewOwner } from "../src/ens-registry"
