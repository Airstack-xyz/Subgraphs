(module
  ...
  (func $~lib/util/string/strtol<f64> (type 9) (param i32) (result f64)
  ...
  (func $modules/airstack/domain-name/utils/byteArrayFromHex (type 0) (param i32) (result i32)
    ...
    local.get 2)
  (func $start:tests/eth-registrar.test~anonymous|0~anonymous|0 (type 4)
  ...
  (func $modules/airstack/domain-name/domain-name/domain.getOrCreateAirNameRegisteredTransaction (type 10) (param i32 i32 i32 i32 i32 i32 i32 i32 i32 i32)
    (local i64)
    i32.const 12848
    block (result i32)  ;; label = @1
      local.get 0
  ...
  (func $src/eth-registrar/handleNameRegistered (type 8) (param i32)
  ...
  (func $start:tests/eth-registrar.test~anonymous|0~anonymous|1 (type 4)
    ...
    call $~lib/array/Array<~lib/@graphprotocol/graph-ts/common/collections/TypedMapEntry<~lib/string/String_~lib/string/String>>#push
    local.get 0
    call $src/eth-registrar/handleNameRegistered
    ...
    call $~lib/@graphprotocol/graph-ts/common/conversion/typeConversion.bigIntToString
    call $~lib/matchstick-as/assembly/assert/assert.fieldEquals)
  (func $modules/airstack/domain-name/domain-name/domain.getOrCreateAirNameRenewedTransaction (type 12) (param i32 i32 i32 i32 i32 i32 i32 i32)
    (local i64 i32)
    i32.const 15424
    block (result i32)  ;; label = @1
      local.get 1
  ...
  (func $start:tests/eth-registrar.test~anonymous|0~anonymous|2 (type 4)
    ...
    call $~lib/@graphprotocol/graph-ts/common/conversion/typeConversion.bigIntToString
    call $~lib/matchstick-as/assembly/assert/assert.fieldEquals)
  (func $start:tests/eth-registrar.test~anonymous|0 (type 4)
    i32.const 5760
    i32.load
    i32.const 5792
  ...
  (elem $0 (i32.const 1) func $start:tests/eth-registrar.test~anonymous|0~anonymous|0 $~lib/@graphprotocol/graph-ts/common/value/Value#displayData~anonymous|0 $start:tests/eth-registrar.test~anonymous|0~anonymous|1 $start:tests/eth-registrar.test~anonymous|0~anonymous|2 $start:tests/eth-registrar.test~anonymous|0)
  ...
  (data (;185;) (i32.const 6540) "<")
  (data (;186;) (i32.const 6552) "\01\00\00\00&\00\00\001\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")
  (data (;187;) (i32.const 6604) "\1c")
  (data (;188;) (i32.const 6616) "\01\00\00\00\04\00\00\00i\00d")
  (data (;189;) (i32.const 6636) "\ac")
  (data (;190;) (i32.const 6648) "\01\00\00\00\9a\00\00\009\001\004\002\009\001\002\006\009\002\000\003\006\007\005\003\000\003\001\003\000\002\003\008\002\007\006\008\002\009\007\006\008\008\008\003\006\000\000\009\007\005\002\002\005\005\003\005\000\006\008\008\000\005\001\007\004\002\003\001\000\003\004\001\009\006\008\002\009\004\003\003\006\004\003\001\008")
  (data (;191;) (i32.const 6812) "\1c")
  (data (;192;) (i32.const 6824) "\01\00\00\00\0a\00\00\00o\00w\00n\00e\00r")
  (data (;193;) (i32.const 6844) "l")
  (data (;194;) (i32.const 6856) "\01\00\00\00T\00\00\000\00x\000\008\004\00b\001\00c\003\00c\008\001\005\004\005\00d\003\007\000\00f\003\006\003\004\003\009\002\00d\00e\006\001\001\00c\00a\00a\00b\00f\00f\008\001\004\008")
  ...
  (data (;406;) (i32.const 15948) "\1c")
  (data (;407;) (i32.const 15960) "\12\00\00\00\08\00\00\00\05")
  (data (;408;) (i32.const 15980) "<")
  (data (;409;) (i32.const 15996) " \00\00\00\a0\04\00\00\c0\04\00\00\e0\04\00\00\10\05\00\000\05\00\00P\05\00\00p\05\00\00\90\05")
  (data (;410;) (i32.const 16044) ",")
  (data (;411;) (i32.const 16056) "\03\00\00\00\10\00\00\00\80>\00\00\80>\00\00 \00\00\00\08"))
